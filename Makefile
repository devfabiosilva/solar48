...
DRIVER_FOLDER=$(SYSTEM_FOLDER)/drivers
DRIVER_COMMUNICATION=$(DRIVER_FOLDER)/communication

# EP 2000
DRIVER_EPEVER2000IC_FOLDER=$(DRIVER_COMMUNICATION)/ep_ip2000
DRIVER_EPEVER2000IC_SRC=$(wildcard $(DRIVER_EPEVER2000IC_FOLDER)/*.c)
DRIVER_EPEVER2000IC_OBJ=$(patsubst $(DRIVER_EPEVER2000IC_FOLDER)/%.c,%.o,$(DRIVER_EPEVER2000IC_SRC))
DRIVER_EPEVER2000IC_OBJ_RELEASE=$(patsubst $(DRIVER_EPEVER2000IC_FOLDER)/%.c,%_release.o,$(DRIVER_EPEVER2000IC_SRC))

# TRACER 6415AN
DRIVER_EPEVER_TRACER6415AN_FOLDER=$(DRIVER_COMMUNICATION)/tracer6415an
DRIVER_EPEVER_TRACER6415AN_SRC=$(wildcard $(DRIVER_EPEVER_TRACER6415AN_FOLDER)/*.c)
DRIVER_EPEVER_TRACER6415AN_OBJ=$(patsubst $(DRIVER_EPEVER_TRACER6415AN_FOLDER)/%.c,%.o,$(DRIVER_EPEVER_TRACER6415AN_SRC))
DRIVER_EPEVER_TRACER6415AN_OBJ_RELEASE=$(patsubst $(DRIVER_EPEVER_TRACER6415AN_FOLDER)/%.c,%_release.o,$(DRIVER_EPEVER_TRACER6415AN_SRC))
...
%.o: $(DRIVER_EPEVER2000IC_FOLDER)/%.c
	@echo "DEBUG: Compiling EPEVER2000 modbus RS485 driver ..."
	$(CC) $(CFLAGS) -I$(SYSTEM_FOLDER_INC) -I$(MIDDLEWARE_FOLDER_INC) -c -o $@ $^

%.o: $(DRIVER_EPEVER_TRACER6415AN_FOLDER)/%.c
	@echo "DEBUG: Compiling TRACER6415AN modbus RS485 driver ..."
	$(CC) $(CFLAGS) -I$(SYSTEM_FOLDER_INC) -I$(MIDDLEWARE_FOLDER_INC) -c -o $@ $^

$(OUT).elf: $(SRC_FOLDER)/main.c $(SYS_OBJ) $(PERIPH_SD1306_OBJ) $(MIDDLEWARE_CONSOLE_OBJ) $(MIDDLEWARE_USB_OBJ) $(MIDDLEWARE_FREE_RTOS_OBJ) $(MIDDLEWARE_INSTANCES_OBJ) $(DRIVER_EPEVER2000IC_OBJ) $(DRIVER_EPEVER_TRACER6415AN_OBJ) $(ASSEMBLY_FOLDER)/$(STARTUP_FILE).S
...
%_release.o: $(DRIVER_EPEVER2000IC_FOLDER)/%.c
	@echo "RELEASE: Compiling EPEVER2000 modbus RS485 driver ..."
	$(CC) $(CFLAGS_RELEASE) -I$(SYSTEM_FOLDER_INC) -I$(MIDDLEWARE_FOLDER_INC) -c -o $@ $^

%_release.o: $(DRIVER_EPEVER_TRACER6415AN_FOLDER)/%.c
	@echo "RELEASE: Compiling TRACER6415AN modbus RS485 driver ..."
	$(CC) $(CFLAGS_RELEASE) -I$(SYSTEM_FOLDER_INC) -I$(MIDDLEWARE_FOLDER_INC) -c -o $@ $^

$(OUT)_release.elf: $(SRC_FOLDER)/main.c $(SYS_OBJ_RELEASE) $(PERIPH_SD1306_OBJ_RELEASE) $(MIDDLEWARE_CONSOLE_OBJ_RELEASE) $(MIDDLEWARE_USB_OBJ_RELEASE) $(MIDDLEWARE_FREE_RTOS_OBJ_RELEASE) $(MIDDLEWARE_INSTANCES_OBJ_RELEASE) $(DRIVER_EPEVER2000IC_OBJ_RELEASE) $(DRIVER_EPEVER_TRACER6415AN_OBJ_RELEASE) $(ASSEMBLY_FOLDER)/$(STARTUP_FILE).S
