...
$(OUT).elf: $(SRC_FOLDER)/main.c $(SYS_OBJ) $(MIDDLEWARE_CONSOLE_OBJ) $(MIDDLEWARE_USB_OBJ) $(MIDDLEWARE_FREE_RTOS_OBJ) $(MIDDLEWARE_INSTANCES_OBJ) $(ASSEMBLY_FOLDER)/$(STARTUP_FILE).S
...
$(OUT)_release.elf: $(SRC_FOLDER)/main.c $(SYS_OBJ_RELEASE) $(MIDDLEWARE_CONSOLE_OBJ_RELEASE) $(MIDDLEWARE_USB_OBJ_RELEASE) $(MIDDLEWARE_FREE_RTOS_OBJ_RELEASE) $(MIDDLEWARE_INSTANCES_OBJ_RELEASE) $(ASSEMBLY_FOLDER)/$(STARTUP_FILE).S
