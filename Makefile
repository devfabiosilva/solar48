...
LDFLAGS = -T $(ASSEMBLY_FOLDER)/$(LINKER_FILE).ld -Wl,--gc-sections -lc -mfloat-abi=soft -lgcc -lnosys --specs=nano.specs -u malloc -u realloc -u free -u memcmp -u strlen -u vsnprintf -u strncmp -u memset -u strncpy -u strtol -u _printf_float -u __aeabi_uldivmod -u __aeabi_i2f -u __aeabi_fmul -u __aeabi_fdiv -u snprintf
