...
*/
 ...
 #define PROCESS_INST_STACK_SIZE 4*configMINIMAL_STACK_SIZE
 #define PROCESS_INT_EXT_STACK_SIZE 4*configMINIMAL_STACK_SIZE
 #define PROCESS_INT_INT_STACK_SIZE 4*configMINIMAL_STACK_SIZE
 #define PROCESS_PERIPH_TIME_EV_STACK_SIZE 4*configMINIMAL_STACK_SIZE
 #define PROCESS_SYS_QUEUE_STACK_SIZE 4*configMINIMAL_STACK_SIZE
 #define PROCESS_RTOS_MILLI_STACK_SIZE 1*configMINIMAL_STACK_SIZE

#endif

//DRIVER EPEVER_IP_2000
#define WITH_EPEVER_IP_2000
#ifdef WITH_EPEVER_IP_2000
 #define EPEVER_IP2000_TIMEOUT 4
#endif
//END DRIVER EPEVER_IP_2000

//DRIVER TRACER6415AN
#define EPEVER_TRACER6415AN
#ifdef EPEVER_TRACER6415AN
 #define EPEVER_TRACER6415AN_TIMEOUT 4
#endif
//END DRIVER TRACER6415AN
